...
type Content = { id: string; title: string; category: string; summary: string; body?: string; mediaId?: string | null; topicType?: VideoTopicType; methodCode?: string | null; methodLabel?: string | null; routes?: Array<{ code: string; label: string; points: string[] }>; pointGroups?: Array<{ code: string; label: string; methodCode: string; points: string[]; relation?: string }>; risks?: string; contraindications?: string; steps?: Array<{ title: string; instruction: string }> };
