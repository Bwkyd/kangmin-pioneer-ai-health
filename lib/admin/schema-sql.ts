export const adminSchemaStatements = [
  "CREATE TABLE IF NOT EXISTS content_items (id TEXT PRIMARY KEY NOT NULL, type TEXT NOT NULL, title TEXT NOT NULL, category TEXT DEFAULT 'unclassified' NOT NULL, summary TEXT DEFAULT '' NOT NULL, body TEXT DEFAULT '' NOT NULL, source TEXT DEFAULT '' NOT NULL, status TEXT DEFAULT 'draft' NOT NULL, version INTEGER DEFAULT 1 NOT NULL, media_id TEXT, metadata TEXT DEFAULT '{}' NOT NULL, published_at TEXT, write_token TEXT, created_at TEXT NOT NULL, updated_at TEXT NOT NULL)",
  ...
  "CREATE TABLE IF NOT EXISTS clinical_approvals (content_id TEXT PRIMARY KEY NOT NULL REFERENCES content_items(id) ON DELETE CASCADE, content_version INTEGER NOT NULL, approver TEXT NOT NULL, approved_at TEXT NOT NULL)",
