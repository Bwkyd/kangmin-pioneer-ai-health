...
export function KnowledgeFolderManager({ items, folders, busy, run, onOpenFiles, initialCreate, initialStatusFilter }: { items: KnowledgeItem[]; folders: KnowledgeFolder[]; busy: boolean; run: (action: () => Promise<void>, success: string) => Promise<boolean>; onOpenFiles: () => void; initialCreate: boolean; initialStatusFilter: KnowledgeStatusFilter }) {
