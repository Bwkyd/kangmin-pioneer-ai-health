...
type Item = { id: string; type: string; title: string; category: string; summary: string; body: string; source: string; status: string; version: number; mediaId?: string | null; metadata: { risks?: string; contraindications?: string; syndromeCodes?: string[]; methodCode?: string | null }; clinicalApproval?: { contentVersion: number; approver?: string | null; approvedAt?: string | null } | null; updatedAt: string };
