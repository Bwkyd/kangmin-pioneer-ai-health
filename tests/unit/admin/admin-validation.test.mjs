...
test("knowledge requires source and completed index", () => {
  ...
  assert.equal(publishProblem("knowledge", { title: "来源", mediaId: "media_1", metadata: "{}" }), "知识资料必须先完成索引");
  assert.equal(publishProblem("knowledge", { title: "来源", mediaId: "media_1", metadata: "{\"indexedChunks\":2}" }), null);
});
